...
| `docs/bible/08-runtime-boundaries.md` | Bible / Runtime | Current | Да | Current Bible source for Trusted Auth, Supabase, Browser Demo, Profile/Avatar, Chat, Share/Join, Weather, Admin/Moderation runtime boundaries. |
