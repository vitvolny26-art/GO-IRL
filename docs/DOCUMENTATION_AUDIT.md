...
GO IRL documentation is now structured around five layers:

1. Current operational docs for closed beta.
2. Product, architecture, and market source-of-truth docs.
3. Competitor and product-scope monitoring docs.
4. Bible / long-form historical product thinking.
5. Generated snapshots and task reports.

The main risk is not missing documentation. The main risk is **scope confusion**: future platform vision, AI discovery, ticketing, CRM, dating, or broad social features can look like current MVP behavior.
...
- keep `docs/MARKET_POSITIONING.md` as the market and MVP feature filter;
- keep `docs/COMPETITOR_WATCH.md` as the competitor signal watchlist;
...
| 2 | `docs/MARKET_POSITIONING.md` | Market positioning source of truth and MVP feature filter. |
| 3 | `docs/COMPETITOR_WATCH.md` | Competitor watchlist and product-signal filter. |
| 4 | `README.md` | Current setup, stack, implemented scope. |
| 5 | `ROADMAP.md` | Current direction and prioritization. |
| 6 | `docs/DEVELOPMENT_PROTOCOL.md` | Safe development rules. |
| 7 | `BETA_TESTING.md`, `BETA_CHECKLIST.md` | Closed beta validation flow. |
| 8 | `RELEASE_NOTES.md` | Release-facing blockers and notes. |
| 9 | `DOCS_INDEX.md` | Documentation registry and archive policy. |
...
| Market | Positioning, competitors, feature import rules, and beta non-goals. |
...
| `docs/bible/01-foundation/01-why-we-exist.md` | partly current | Preserve; reconcile language with `PRODUCT_PHILOSOPHY.md` and `MARKET_POSITIONING.md`. |
| `docs/bible/01-foundation/02-core-principles.md` | partly current | Preserve; reconcile with Constitution and market guardrails. |
...
| `docs/bible/04-modules-architecture.md` | needs audit | Compare with Sport-first and Olomouc beta focus. |
| `docs/bible/05-product-requirements.md` | draft | Split into MVP 1.0, beta market scope, and 1.1 requirements. |
...
- Future Event Roles after Sport Coach validation.
...
| Broad vertical platform vs Olomouc beta market focus. | `ROADMAP.md`, `BACKLOG.md`, `docs/vertical-experiences.md`, `docs/MARKET_POSITIONING.md`, `src/types.ts`, `src/verticals/*` | Keep architecture, but label future scope and enforce six beta categories. |
| Competitor feature imports vs MVP scope. | `docs/COMPETITOR_WATCH.md`, `ROADMAP.md`, `BACKLOG.md` | Borrow only mechanics that reduce friction to real-life attendance. |
...
5. Add `docs/MARKET_POSITIONING.md` and `docs/COMPETITOR_WATCH.md` as market source-of-truth docs.
6. Sync `README.md`, `ROADMAP.md`, `BACKLOG.md`, `CHANGELOG.md`, and `RELEASE_NOTES.md` with market guardrails.
7. Update Bible completion docs with missing sections and 1.0 / 1.1 split.
8. Sync `README.md`, `RELEASE_NOTES.md`, and `docs/Security.md` wording around trusted auth status.
9. Sync `docs/SPORT_COACH_MVP.md` with current MVP vs planned 1.1 / 1.2.
10. Update `project-audit/GO_IRL_PROJECT_AUDIT.md` with documentation cleanup results if that file exists or is recreated.
...
- Competitor-inspired features can bloat MVP if not filtered through `MARKET_POSITIONING.md`.
...
Goal: mark Bible as incomplete, split App 1.0 vs 1.1+ missing sections, add market positioning / competitor boundaries, and prevent future vision from being treated as current MVP scope.
