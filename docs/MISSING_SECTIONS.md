...
| Bible completion | Incomplete | Existing archive is not final; define missing chapters and MVP 1.0/1.1 final Bible plan. | `docs/bible/00-completion-audit.md`, `docs/bible/00-bible-roadmap.md` |
