...
- Create Event validates required text, length limits, capacity, and price before publishing.
...
- Profile stores favorite activities locally for recommendation matching.
...
- Production Supabase persists `city_id`, `metadata`, `participant_note`, and `activity_type` for events as primary database fields.
